---
description: Runs the planning group — produces spec.md, design.md, diagrams, ADRs, and a parallelism-optimized tasks.md, then returns a Handoff Package.
argument-hint: <slug or feature description>
---

Run the planning group for: **$ARGUMENTS**
...
Per @.claude/skills/spec-workflow/SKILL.md:
...
> Next: `/run-build <slug>` to execute the build-review loop.
