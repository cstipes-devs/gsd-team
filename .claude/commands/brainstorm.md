---
description: Structured ideation for a new feature — asks clarifying questions, then writes requirements.md as the seed for the planning group.
argument-hint: <what you want to build>
---

Run a structured brainstorm for: **$ARGUMENTS**

## How to run this

Ask the user clarifying questions — **up to 10, but stop as soon as you have enough**. Use `AskUserQuestion`, batching related questions rather than asking one at a time. Cover the ground that actually changes the design:
